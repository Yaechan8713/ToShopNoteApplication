...
//                adapter.remove(item);
    ...
    public void resurch(View v){
        if(deletint == 0){
            ...
            menufoodItem item = new Select().from(menufoodItem.class).where("menufoodname = ?",resurchstring).executeSingle();
            ...
            if(item == null){
                new AlertDialog.Builder(menufoodActivity.this)
                ...
                resurchdeishitem = item.menufoodname;
